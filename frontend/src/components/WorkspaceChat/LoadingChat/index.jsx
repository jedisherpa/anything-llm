...
export default function LoadingChat() {
  ...
  return (
    <div
      className="transition-all duration-500 relative md:mx-[16px] md:my-[16px] md:rounded-[16px] bg-theme-bg-secondary w-full h-full overflow-y-scroll no-scroll p-4"
