const e={onboarding:{home:{title:"Velkommen til",getStarted:"Kom godt i gang"},llm:{title:"LLM-præference",description:"AnythingLLM kan arbejde med mange LLM-udbydere. Dette vil være den tjeneste, der håndterer chat."},userSetup:{title:"Brugeropsætning",description:"Konfigurer dine brugerindstillinger.",howManyUsers:"Hvor mange brugere vil benytte denne instans?",justMe:"Kun mig",myTeam:"Mit team",instancePassword:"Instansadgangskode",setPassword:"Vil du oprette en adgangskode?",passwordReq:"Adgangskoder skal være på mindst 8 tegn.",passwordWarn:"Det er vigtigt at gemme denne adgangskode, da der ikke findes nogen metode til genoprettelse.",adminUsername:"Brugernavn til admin-konto",adminPassword:"Adgangskode til admin-konto",adminPasswordReq:"Adgangskoder skal være på mindst 8 tegn.",teamHint:"Som standard vil du være den eneste administrator. Når onboarding er fuldført, kan du oprette og invitere andre til at blive brugere eller administratorer. Glem ikke din adgangskode, da kun administratorer kan nulstille adgangskoder."},data:{title:"Datahåndtering & Privatliv",description:"Vi er forpligtet til gennemsigtighed og kontrol, når det gælder dine persondata.",settingsHint:"Disse indstillinger kan ændres når som helst under indstillingerne."},survey:{title:"Velkommen til AnythingLLM",description:"Hjælp os med at gøre AnythingLLM tilpasset dine behov. Valgfrit.",email:"Hvad er din e-mail?",useCase:"Hvad vil du bruge AnythingLLM til?",useCaseWork:"Til arbejde",useCasePersonal:"Til personligt brug",useCaseOther:"Andet",comment:"Hvordan hørte du om AnythingLLM?",commentPlaceholder:"Reddit, Twitter, GitHub, YouTube, etc. - Fortæl os, hvordan du fandt os!",skip:"Spring undersøgelsen over",thankYou:"Tak for din feedback!"}},common:{"workspaces-name":"Navn på arbejdsområder",user:"Bruger",selection:"Modelvalg",saving:"Gemmer...",save:"Gem ændringer",previous:"Forrige side",next:"Næste side",optional:"Valgfrit",yes:"Ja",no:"Nej",search:"Søg",username_requirements:"Brugernavnet skal bestå af 2-32 tegn, starte med et lille bogstav, og kun indeholde små bogstaver, tal, understregninger, bindestreger og punktummer."},settings:{title:"Instansindstillinger",invites:"Invitationer",users:"Brugere",workspaces:"Arbejdsområder","workspace-chats":"Arbejdsområde-chat",customization:"Tilpasning","api-keys":"Udvikler API",llm:"LLM",transcription:"Transskription",embedder:"Indlejring","text-splitting":"Tekst-splitter og opdeling","voice-speech":"Stemme & Tale","vector-database":"Vektordatabase",embeds:"Chat-indlejring",security:"Sikkerhed","event-logs":"Hændelseslog",privacy:"Privatliv & Data","ai-providers":"AI-udbydere","agent-skills":"Agentfærdigheder",admin:"Administrator",tools:"Værktøjer","experimental-features":"Eksperimentelle funktioner",contact:"Kontakt support","browser-extension":"Browserudvidelse","system-prompt-variables":`System Prompt Variables

System Prompt Variabler`,interface:"Brugerpræferencer",branding:"Brandstrategi og white-labeling",chat:"Chat","mobile-app":"AnythingLLM Mobile","community-hub":{title:"Fælleshus",trending:"Udforsk populære emner","your-account":"Dit konti","import-item":"Importeret vare"}},login:{"multi-user":{welcome:"Velkommen til","placeholder-username":"Brugernavn","placeholder-password":"Adgangskode",login:"Log ind",validating:"Validerer...","forgot-pass":"Glemt adgangskode",reset:"Nulstil"},"sign-in":"Log ind på din {{appName}} konto.","password-reset":{title:"Nulstilling af adgangskode",description:"Angiv de nødvendige oplysninger nedenfor for at nulstille din adgangskode.","recovery-codes":"Gendannelseskoder","back-to-login":"Tilbage til log ind"}},"new-workspace":{title:"Nyt arbejdsområde",placeholder:"Mit arbejdsområde"},"workspaces—settings":{general:"Generelle indstillinger",chat:"Chatindstillinger",vector:"Vektordatabase",members:"Medlemmer",agent:"Agentkonfiguration"},general:{vector:{title:"Antal vektorer",description:"Samlet antal vektorer i din vektordatabase."},names:{description:"Dette vil kun ændre visningsnavnet på dit arbejdsområde."},message:{title:"Foreslåede chatbeskeder",description:"Tilpas de beskeder, der vil blive foreslået til brugerne af dit arbejdsområde.",add:"Tilføj ny besked",save:"Gem beskeder",heading:"Forklar mig",body:"fordelene ved AnythingLLM"},delete:{title:"Slet arbejdsområde",description:"Slet dette arbejdsområde og alle dets data. Dette vil slette arbejdsområdet for alle brugere.",delete:"Slet arbejdsområde",deleting:"Sletter arbejdsområde...","confirm-start":"Du er ved at slette dit hele","confirm-end":`arbejdsområde. Dette vil fjerne alle vektor-indlejringer i din vektordatabase.

De oprindelige kildefiler forbliver uberørte. Denne handling kan ikke fortrydes.`}},chat:{llm:{title:"Arbejdsområdets LLM-udbyder",description:"Den specifikke LLM-udbyder og -model, der vil blive brugt for dette arbejdsområde. Som standard anvendes systemets LLM-udbyder og indstillinger.",search:"Søg blandt alle LLM-udbydere"},model:{title:"Arbejdsområdets chatmodel",description:"Den specifikke chatmodel, der vil blive brugt for dette arbejdsområde. Hvis tom, anvendes systemets LLM-præference."},mode:{title:"Chat-tilstand",chat:{title:"Chat","desc-start":"vil give svar baseret på LLM'ens generelle viden",and:"og","desc-end":"dokumentkontekst der findes."},query:{title:"Forespørgsel","desc-start":"vil give svar",only:"kun","desc-end":"hvis dokumentkontekst findes."}},history:{title:"Chat-historik","desc-start":"Antallet af tidligere chats, der vil blive inkluderet i svarens korttidshukommelse.",recommend:"Anbefal 20. ","desc-end":"Alt over 45 kan sandsynligvis føre til gentagne chat-fejl afhængigt af beskedstørrelsen."},prompt:{title:"Prompt",description:"Prompten, der vil blive brugt i dette arbejdsområde. Definér konteksten og instruktionerne til, at AI'en kan generere et svar. Du bør levere en omhyggeligt udformet prompt, så AI'en kan generere et relevant og præcist svar.",history:{title:`System Prompt History
